module github.com/terraform-ibm-modules/terraform-ibm-ocp-all-inclusive
...
require (
	...
	github.com/terraform-ibm-modules/ibmcloud-terratest-wrapper v1.38.0
)
...
require (
	...
	github.com/IBM/platform-services-go-sdk v0.68.0 // indirect
