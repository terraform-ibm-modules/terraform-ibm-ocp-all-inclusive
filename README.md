...
| <a name="module_ocp_base"></a> [ocp\_base](#module\_ocp\_base) | terraform-ibm-modules/base-ocp-vpc/ibm | 3.11.3 |
...
| <a name="input_kms_cross_account_id"></a> [kms\_cross\_account\_id](#input\_kms\_cross\_account\_id) | Id of the account that owns the KMS instance to encrypt the cluster | `string` | `null` | no |
